...
interface IColorFillProps {
    color?: string
    changeColor?: (color: string) => void
}

class ColorFill extends React.Component<IColorFillProps, any> {
    static colorFormat = colorFormat
    constructor(props: IColorFillProps) {
        super(props)
    ...
    componentDidUpdate(prevProps: IColorFillProps) {
                ...
                <div className="color-picker-panel-wrap-alpha">
                    <div className="color-picker-panel-alpha">
                        <div
                            ...
                            style={{
                                background: `linear-gradient(to right, rgba(${r}, ${g}, ${b}, 0),
                                rgb(${r}, ${g}, ${b}))`
                            }}
                        />
                        <span style={{ left: `${a}%` }} onMouseDown={this.changeAlphaStart} />
                        <div className="color-picker-panel-alpha-handler" onClick={e => this.changeAlpha(e.clientX)} />
                    </div>
                </div>
    ...
    renderParams = () => {
        ...
        return (
            <div className="color-picker-panel-wrap" style={{ height: '45px', marginTop: '6px' }}>
                <div
                    ...
                    <div className="color-picker-panel-params-input">
                        ...
                        <input type="number" value={a} onChange={e => this.changeColorOnInput(e, 'a', 100)} />
                    </div>
    ...
    renderRecentColor = () => {
        ...
        return (
            <div
                ...
                <div
                    className={classNames({
                        ['collapse-panel-content-wp']: true,
                        ['collapse-panel-content-wp-hide']: visible === '0'
                    })}>
    ...
    changeRibbon = (clientX: number) => {
        const sliderElem: any = document.querySelector('.color-picker-panel-ribbon')
    ...
    changeAlpha = (clientX: number) => {
        const sliderElem: any = document.querySelector('.color-picker-panel-alpha')
        const { x, width } = sliderElem.getBoundingClientRect()
        const pos = clientX - x
    ...
    toggleRecentColor = () => {
        ...
        this.setState({ openRecent: visible === '0' ? '1' : '0' })
    }
}
